...
public class DisplayingMyScreenHistoryWhenThereAreNoPastEventsTest extends BaseTest {
    ...
    public void DisplayingMyScreenHistoryWhenThereAreNoPastEventsTest() {
        ...
        Assert.assertTrue(driver.findElement(mySpacePage.getNoEventMessage()).isDisplayed(),"No events booked in the last 10 days is not displayed on Tiles List Placeholder.");
    }
}
