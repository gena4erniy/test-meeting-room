...
public class TapNextChooseCorrectOfficeTests extends BaseTest {
    ...
    @Owner("Sirozh E.")
    @TmsLink("5630209")
    @Test(description = "The List of countries page is displayed , The List of cities page for Belarus is displayed , \n" +
            " Tap on the Gomel item , The location choice is saved on the User's device , My space page is displayed.")
